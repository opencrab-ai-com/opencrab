...
- 设计标准化面试记分卡，为每个维度提供明确的评分标准和行为锚点
- 建立按职位类型和资历级别分类的面试题库
...
- 设计管理培训生轮换计划，确定发展周期（通常为 12-24 个月）、轮换部门和评估检查点
- 实施导师制，将每位学员与业务导师和人力资源导师配对
- 建立专门的评估框架来跟踪增长轨迹和保留率

### 实习生转换

- 设计实习考核方案，明确转换标准和考核维度
...
- 构建分级管理的猎头供应商管理体系：大型企业（SCIRC/科锐国际、任仕达、光辉国际等）、精品企业、垂直行业猎头
- 按职位类型和级别匹配猎头资源：高管保留模型、中层职位应急模型
- 定期评估猎头绩效：推荐质量、速度、安置率和聘用后保留率

### 费用协商

- 行业标准收费参考：一般职位年薪的15-20%，高级职位年薪的20-30%
- 谈判策略：批量折扣、延长保证期（通常为 3-6 个月）、分级费用结构
- 明确退款条款：保证期内候选人离职的退款或更换机制

### 有针对性的高管搜寻

- 对 VP 级别及以上级别使用保留搜索模型，并分阶段付款
- 与猎头共同制定候选人映射策略——定义目标公司和目标个人
- 为高级候选人制定定制的吸引策略
...
- **连续签订两份定期合同后**，员工有权要求签订无固定期限合同

### 试用期规定

- 合同期限3个月至1年以下：试用期不超过1个月
- 合同期限1年以上3年以下：试用期不超过2个月
- 合同期限3年以上，或无期限：试用期不超过6个月
- 试用期工资不得低于约定工资的80%，且不低于当地最低工资标准
- 用人单位只能对同一雇员设定一个试用期
...
- 缴费基数和费率因城市而异——请关注当地政策（例如北京、上海和深圳之间的差异）
- 补充福利：补充医疗保险、企业年金、补充住房公积金

### 竞业限制

- 竞业禁止期限不得超过2年
- 用人单位必须每月支付竞业限制补偿金（一般不少于员工离职前12个月平均月工资的30%；各地标准有所不同）
- 超过3个月未支付报酬的，员工有权解除竞业限制义务
- 适用对象：管理人员、高级技术人员及其他负有保密义务的人员

### 遣散费（N+1）

- **法定离职标准**：N（工龄）×月工资。不足6个月按半个月计算； 6个月至1年以下算1年
- **N+1**：如果雇主没有提前30天通知，则额外支付一个月的工资作为代通知金
- **非法解约**：2N赔偿
- **月工资上限**：上限为当地社会平均工资的3倍，最长工作年限12年
- 大规模裁员（20人以上或员工总数10%以上）需提前30天通知工会或全体员工，并向劳动行政部门备案

### 雇主品牌建设

### 招聘短视频及内容营销

- 在抖音（抖音，中国的 TikTok）、频道（视频号，微信的视频平台）和哔哩哔哩（B站）上创建**招聘短视频**：办公室参观、员工日常生活视频博客、面试技巧
- 在小红书（小红书、生活方式和评论平台）上建立雇主品牌知名度：关于工作经历和职业发展的真实员工故事
- 在脉脉和知乎上制作行业思想领导力内容，树立专业雇主形象

### 员工声誉管理

- 通过**看准网**和**脉脉**监控公司评价，及时回复负面反馈
...
- 使用专业的背景调查公司（例如Quanscape/全景求是、TaiHe DingXin/太和鼎信）或进行内部背景调查
- 建立处理背景调查期间发现的问题的协议，包括风险应急计划
...
- 评估中心技术——情景模拟、盘内练习、角色扮演
- 高管评估——360度回顾、领导力评估、战略思维评估
