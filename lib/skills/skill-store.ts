...
> = {
  ...
  brainstorming: {
    name: "Brainstorming",
    summary: "Turn rough ideas into a clear design through structured discovery and trade-off exploration",
    category: "business-ops",
    icon: "puzzle",
  },
  "writing-plans": {
    name: "Writing Plans",
    summary: "Break an approved design into explicit implementation tasks with tests, files, and commands",
    category: "business-ops",
    icon: "doc",
  },
  "dispatching-parallel-agents": {
    name: "Dispatching Parallel Agents",
    summary: "Split independent work into isolated parallel agent tasks with tightly scoped context",
    category: "product-tech",
    icon: "puzzle",
  },
  "subagent-driven-development": {
    name: "Subagent-Driven Development",
    summary: "Execute plans by dispatching fresh subagents per task with structured review checkpoints",
    category: "product-tech",
    icon: "puzzle",
  },
  "executing-plans": {
    name: "Executing Plans",
    summary: "Implement a written plan step by step with review checkpoints and explicit completion gates",
    category: "product-tech",
    icon: "doc",
  },
  "systematic-debugging": {
    name: "Systematic Debugging",
    summary: "Find root cause before fixing bugs, test failures, or unexpected runtime behavior",
    category: "product-tech",
    icon: "puzzle",
  },
  "test-driven-development": {
    name: "Test-Driven Development",
    summary: "Drive features and fixes with failing tests first, then minimal implementation and refactor",
    category: "product-tech",
    icon: "github",
  },
  "requesting-code-review": {
    name: "Requesting Code Review",
    summary: "Ask for focused review before merge so bugs and regressions are caught early",
    category: "product-tech",
    icon: "github",
  },
  "receiving-code-review": {
    name: "Receiving Code Review",
    summary: "Evaluate review feedback rigorously instead of accepting unclear or incorrect suggestions blindly",
    category: "product-tech",
    icon: "github",
  },
  "verification-before-completion": {
    name: "Verification Before Completion",
    summary: "Require evidence from commands and tests before claiming work is complete or fixed",
    category: "product-tech",
    icon: "github",
  },
  "finishing-a-development-branch": {
    name: "Finishing a Development Branch",
    summary: "Close out completed work with verified status, clear integration choices, and cleanup",
    category: "business-ops",
    icon: "github",
  },
  "using-git-worktrees": {
    name: "Using Git Worktrees",
    summary: "Create isolated git workspaces safely for parallel feature work and implementation plans",
    category: "product-tech",
    icon: "github",
  },
  "using-superpowers": {
    name: "Using Superpowers",
    summary: "Discover and apply the right workflow skill at the start of a task instead of improvising",
    category: "general",
    icon: "puzzle",
  },
  "writing-skills": {
    name: "Writing Skills",
    summary: "Create or refine skills with test-driven pressure scenarios and verification before shipping",
    category: "product-tech",
    icon: "doc",
  },
  "skill-creator": {
