...
当前 `OpenCrab for Mac` 已经发布，你可以直接下载桌面 App：[OpenCrab Desktop v0.1.1](https://github.com/opencrab-ai-com/opencrab/releases/tag/v0.1.1)。
...
- 当前已发布版本：`[OpenCrab Desktop v0.1.1](https://github.com/opencrab-ai-com/opencrab/releases/tag/v0.1.1)`
